let oneRoom = [{  // 변수가 오직 한개면 여기서 바로 변수명없이 "export default [{ ... 라고 써도 된다. 
    id : 0,
    title: "신림역 30미터 거리 one room",
    ...
    {
    id : 1,
    title: "창동 Aurora Bedroom(Queen-size)",
...
export default oneRoom //or export {oneRoom}